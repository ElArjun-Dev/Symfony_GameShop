...

    {
        ...
        $builder
            ...
            ->add('releaseDate', DateTimeType::class, [
                'label' => 'Date de sortie (jj/mm/yyyy)',
                'widget' => 'single_text',
                'html5' => false,
                'format' => 'DD/MM/YYYY',
            ...
            //chalo pour s'occuper des notes
            //ICi on va imbrique le formulaire de NOtetype
            ->add('note', NoteType::class, [
                'label' => false
            ])
            //champ pour récupérer les ages
            ->add('age', EntityType::class, [
                'label' => 'Restriction age',
                'class' => Age::class,
                'choice_label' => 'label',
                'attr' => ['class' => 'form-control mb-3']
            ])
            // champ pour recuperer les console
